...
genus_lake_roll_multi_ews <- pbapply::pblapply(list(kin_yr_dat,kas_yr_dat,LZ_yr_dat,mad_yr_dat,
                                         ...
                                         FUN = function(x){
                                           ...
                                           sub_dat_det <- EWSmethods::detrend_ts(sub_dat,method = "gaussian",span = 0.75,degree=1) 
...
genus_lake_roll_uni_ews_perm <- pbmcapply::pbmclapply(list(kin_yr_dat,kas_yr_dat,LZ_yr_dat,mad_yr_dat,
                                            ...
                                            FUN = function(x){
                                              ...
                                              foreach(i=colnames(x[,-1]), .combine='rbind',.export = "perm_rollEWS",.verbose = F) %do%{
